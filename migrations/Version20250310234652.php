...
final class Version20250310234652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE credit_cards (id INT AUTO_INCREMENT NOT NULL, card_type_id INT NOT NULL, bank_id INT NOT NULL, product_id INT NOT NULL COMMENT \'product id & productid: Unique ID of the product\', name VARCHAR(255) NOT NULL COMMENT \'produkt: Product title\', sort INT DEFAULT NULL, has_admin_edition TINYINT(1) DEFAULT 0 NOT NULL, original_values JSON DEFAULT NULL COMMENT \'original_values: Original values of the credit card\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_5CADD6534584665A (product_id), INDEX idx_credit_card_product (product_id), INDEX idx_credit_card_bank (bank_id), INDEX idx_credit_card_type (card_type_id), INDEX idx_credit_card_sort (sort), INDEX idx_credit_card_has_admin_edition (has_admin_edition), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
